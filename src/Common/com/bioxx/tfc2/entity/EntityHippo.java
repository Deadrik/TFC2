...
public class EntityHippo extends EntityAnimal 
{
	Gender gender;
	protected static final DataParameter<Gender> GENDER = EntityDataManager.createKey(EntityHippo.class, DataSerializersTFC.GENDER);
