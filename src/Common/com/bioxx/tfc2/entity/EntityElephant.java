...
public class EntityElephant extends EntityAnimal 
{
	...
	protected static final DataParameter<Gender> GENDER = EntityDataManager.createKey(EntityElephant.class, DataSerializersTFC.GENDER);
	protected static final DataParameter<ElephantType> ELEPHANTTYPE = EntityDataManager.createKey(EntityElephant.class, DataSerializersTFC.ELEPHANTTYPE);
	...
	protected void entityInit ()
	{
		...
		getDataManager().register(ELEPHANTTYPE, elephantType);
	}
	...
	{
		this.elephantType = t;
		getDataManager().set(ELEPHANTTYPE, t);
	}

	public ElephantType getElephantType()
	{
		return getDataManager().get(ELEPHANTTYPE);
	}
