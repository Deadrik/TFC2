...
public class BlockStoneStalac extends BlockTerra
{
	...
	private static AxisAlignedBB AABB_2 = new AxisAlignedBB(0.25,0,0.25,0.75,0.8125,0.75);
	...
	public int getSize(IBlockState state, IBlockAccess world, BlockPos pos)
	{
		...
		for (int i = 1; i < 4; i++)
		{
			IBlockState otherState = world.getBlockState(pos.down(i));
