...
{
	ModelRendererTFC Neck;
	ModelRendererTFC Tail;
	ModelRendererTFC HEAD;
	ModelRendererTFC BODY;
	ModelRendererTFC LegLEFTREAR;
	ModelRendererTFC LegLEFTFRONT;
	ModelRendererTFC LegRIGHTFRONT;
	ModelRendererTFC LegRIGHTREAR;
	...
	public ModelLion()
	{
		...
		setTextureOffset("HEAD.LionMane", 12, 0);
		setTextureOffset("HEAD.ManeRight", 12, 1);
		setTextureOffset("HEAD.ManeLeft", 17, 1);
		...
		Neck = new ModelRendererTFC(this, 18, 16);
		Neck.addBox(-1.5F, 1F, -3F, 3, 3, 6);
		Neck.setRotationPoint(0F, 8F, 0F);
		Neck.setTextureSize(64, 32);
		Neck.mirror = true;
		setRotation(Neck, -0.5235988F, 0F, 0F);
		Tail = new ModelRendererTFC(this, 49, 0);
		Tail.addBox(-0.5F, 1F, 0F, 1, 12, 1);
		Tail.setRotationPoint(0F, 9F, 16F);
		Tail.setTextureSize(64, 32);
		Tail.mirror = true;
		setRotation(Tail, 0F, 0F, 0F);
		HEAD = new ModelRendererTFC(this, "HEAD");
		HEAD.setRotationPoint(0F, 9F, -2F);
		setRotation(HEAD, 0F, 0F, 0F);
		HEAD.mirror = true;
		HEAD.addBox("EarLeft", 1.5F, -3F, -2F, 2F, 2F, 1F);
		HEAD.addBox("EarRight", -3.5F, -3F, -2F, 2F, 2F, 1F);
		HEAD.addBox("LionMane", -3.5F, -3.5F, -3F, 7F, 9F, 5F);
		HEAD.addBox("ManeRight", -4.5F, -2F, -3F, 1F, 6F, 5F);
		HEAD.addBox("ManeLeft", 3.5F, -2F, -3F, 1F, 6F, 5F);
		HEAD.addBox("Head", -2.5F, -2F, -4F, 5F, 4F, 4F);
		HEAD.addBox("Snout", -1.5F, -0.5F, -6F, 3F, 2F, 2F);
		HEAD.addBox("Jaw", -1F, 1.5F, -6F, 2F, 1F, 4F);
		BODY = new ModelRendererTFC(this, "BODY");
		BODY.setRotationPoint(0F, 12F, 13F);
		setRotation(BODY, 0F, 0F, 0F);
		BODY.mirror = true;
		BODY.addBox("Torso", -3F, -3F, -13F, 6F, 7F, 16F);
		LegLEFTREAR = new ModelRendererTFC(this, "LegLEFTREAR");
		...
		LegLEFTFRONT = new ModelRendererTFC(this, "LegLEFTFRONT");
		...
		LegRIGHTFRONT = new ModelRendererTFC(this, "LegRIGHTFRONT");
		...
		LegRIGHTREAR = new ModelRendererTFC(this, "LegRIGHTREAR");
	...
	public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
	{
		...
		if(((EntityLion)entityIn).getGender() == Gender.Male)
		{
