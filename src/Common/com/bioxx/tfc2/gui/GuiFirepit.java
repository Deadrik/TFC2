...
public class GuiFirepit extends GuiContainerTFC
{
	...
	public GuiFirepit(InventoryPlayer par1IInventory, TileFirepit inv, World world, int x, int y, int z)
	{
		super(new ContainerFirepit(par1IInventory, inv, world, x, y, z), 176, 85);
	}
