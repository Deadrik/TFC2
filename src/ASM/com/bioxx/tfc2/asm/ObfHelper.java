...
public class ObfHelper
{
	...
	public static String getDescriptor(String className, String typeName)
	{
		return "L" + getInternalClassName(className) + "<" +getInternalClassName(typeName) +";>;";
	}
